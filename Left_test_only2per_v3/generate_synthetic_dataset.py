...
CHARACTERS = [
    {
        "id": "Sera",
        "lora_name": "LoRA_Sera",
        #  触发词 + 极具辨识度的埃及/暗肤色/红裙特征，剔除过于细碎的饰品词以防注意力稀释
...
# ===================== side_by_side / handshake 交换绘制顺序，先p1(128)后p2(255) =====================
def generate_mask(scene):
    ...
    if scene == "side_by_side":
        ...
        # 后画上层 Person2 (255 右侧)，重叠区域保留255，不会被覆盖丢失
