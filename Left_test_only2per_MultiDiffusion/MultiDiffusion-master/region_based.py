...
if __name__ == '__main__':
    ...
    parser.add_argument('--mask_paths', nargs='+', type=str)
    ...
    parser.add_argument('--fg_prompts', nargs='+', type=str)
    parser.add_argument('--fg_negative', nargs='*', type=str, default=[])  
    ...
    if opt.bg_negative is None:
        opt.bg_negative = ''
    if not opt.fg_negative:
        opt.fg_negative = [''] * len(opt.fg_prompts)
    elif len(opt.fg_negative) == 1:
        opt.fg_negative = opt.fg_negative * len(opt.fg_prompts)
